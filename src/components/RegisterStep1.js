...
const RegisterStep1 = () => {
    ...
    return (
        <div>
            <h2>А что если.. по другую сторону экрана будет не виртуальный зверёк, живущий по своим алгоритмам, а настоящий человек, отыгрывающий роль питомца?.. О котором вы будете заботиться и ухаживать,а взамен получать любовь и преданность.</h2>
